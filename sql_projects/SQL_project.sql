# Project Description
# The company Banking Intelligence wants to develop a supervised machine learning model to predict the future behaviour of its customers, based on 
# transactional data and product ownership characteristics. The aim of the project is to create a denormalised table with a series of indicators 
# (features) derived from the tables available in the database, which represent the behaviour and financial activities of customers.
# The main goal is to create a feature table for training machine learning models, enriching customer data with various indicators calculated from 
# their transactions and accounts. The final table will refer to the customer ID and contain both quantitative and qualitative information.
# The denormalised table will allow advanced behavioural features to be extracted for training supervised machine learning models, providing numerous 
# benefits for the company:
# - Predicting customer behaviour: By analysing transactions and product ownership, behavioural patterns can be identified that are useful for 
# predicting future actions such as purchasing new products or closing accounts;
# - Reduction in churn rate: Using behavioural indicators, a model can be built to identify customers at risk of churn, allowing for timely 
# intervention by the marketing team;
# - Improved risk management: Segmentation based on financial behaviour allows you to identify high-risk customers and optimise credit and risk 
# strategies;
# - Personalisation of offers: The extracted features can be used to personalise product and service offers based on the habits and preferences of 
# individual customers, thereby increasing customer satisfaction;
# - Fraud prevention: By analysing transactions by type and amount, the model can detect behavioural anomalies indicative of fraud, improving security
# and prevention strategies.
# These benefits will lead to an overall improvement in business operations, enabling greater efficiency in customer management and sustainable 
# business growth.
