...
ProfessionAI, a company specialising in artificial intelligence-based automation, wants to develop a software library capable of analysing and classifying incoming emails. The main objective is to identify spam emails in order to subsequently conduct in-depth analyses of their content.
The CEO has expressed the need to focus on SPAM emails to better understand the associated trends, content and behaviours. This information will be used to improve the security of corporate communications and refine anti-spam filters.

The CTO provided a dataset of emails to perform the following tasks:
- Train a classifier to identify SPAM emails;
- Identify the main topics among emails classified as SPAM;
- Calculate the semantic distance between the topics obtained to assess the heterogeneity of SPAM email content;
- Extract information about the organisations mentioned from emails that are NOT SPAM.

Email analysis provides ProfessionAI with several strategic advantages:
- Improved spam filter: An efficient classifier significantly reduces the volume of unwanted emails reaching the inbox, optimising the management of corporate communications;
- In-depth content analysis: Identifying the main topics covered in spam emails provides valuable information on trends, themes and recurring patterns, enhancing cybersecurity strategies;
- Heterogeneity assessment: The semantic distance between topics allows us to understand the diversity of SPAM content, which is useful for optimising defences against a wide range of attacks;
- Organisation identification: Extracting organisations from legitimate emails can be used to improve business intelligence processes and better manage communications with customers and partners.
"""
